...
/**
 * Delta point (<a href="https://templates.machinezoo.com/iso-19794-2-2011#deltadef">DELTADEF</a>).
 */
public class Iso19794p2v2011Delta {
	/**
	 * Delta X position (<a href="https://templates.machinezoo.com/iso-19794-2-2011#deltax">DELTAX</a>).
	 */
	public int positionX;
	/**
	 * Delta Y position (<a href="https://templates.machinezoo.com/iso-19794-2-2011#deltay">DELTAY</a>).
	 */
	public int positionY;
	/**
	 * List of delta angles (<a href="https://templates.machinezoo.com/iso-19794-2-2011#deltaangle">DELTAANGLE</a>).
	 * This field is either {@code null} or it is an array of exactly three angles.
	 */
	public int[] angles;
	/**
	 * Creates new delta point (<a href="https://templates.machinezoo.com/iso-19794-2-2011#deltadef">DELTADEF</a>).
	 */
	public Iso19794p2v2011Delta() {
	}
	Iso19794p2v2011Delta(TemplateReader in) {
