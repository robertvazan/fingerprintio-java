...
/**
 * Core point (<a href="https://templates.machinezoo.com/iso-19794-2-2011#coredef">COREDEF</a>).
 */
public class Iso19794p2v2011Core {
	/**
	 * Core X position (<a href="https://templates.machinezoo.com/iso-19794-2-2011#corex">COREX</a>).
	 */
	public int positionX;
	/**
	 * Core Y position (<a href="https://templates.machinezoo.com/iso-19794-2-2011#corey">COREY</a>).
	 */
	public int positionY;
	/**
	 * Core angle (<a href="https://templates.machinezoo.com/iso-19794-2-2011#coreangle">COREANGLE</a>).
	 * This field is {@code null} if core angle is not present.
	 */
	public Integer angle;
	/**
	 * Creates new core point (<a href="https://templates.machinezoo.com/iso-19794-2-2011#coredef">COREDEF</a>).
	 */
	public Iso19794p2v2011Core() {
	}
	Iso19794p2v2011Core(TemplateReader in) {
