...
public class Iso19794p2v2011ZonalExtension {
	...
	/**
	 * Zonal quality vendor (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonevendor">ZONEVENDOR</a>).
	 * Defaults to {@link IbiaOrganizations#UNKNOWN}.
	 */
	public int vendor = IbiaOrganizations.UNKNOWN;
	/**
	 * Zonal quality algorithm (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonealgo">ZONEALGO</a>).
	 */
	public int algorithm;
	/**
	 * Zone width (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonewidth">ZONEWIDTH</a>).
	 */
	public int zoneWidth;
	/**
	 * Zone height (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zoneheight">ZONEHEIGHT</a>).
	 */
	public int zoneHeight;
	/**
	 * Bits per zone (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonebits">ZONEBITS</a>).
	 * Defaults to 8.
	 */
	public int bits = 8;
	/**
	 * Zonal quality data (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonalquality">ZONALQUALITY</a>).
	 * Every array item represents quality of one zone.
	 */
	public int[] quality;
	/**
	 * Creates new zonal quality extension (<a href="https://templates.machinezoo.com/iso-19794-2-2011#zonalext">ZONALEXT</a>).
	 */
	...
	int measure() {
		return 4 + 7 + (quality.length * bits + 7) / 8;
	}
	void validate(int imageWidth, int imageHeight) {
		ValidateTemplate.int16(vendor, "Zonal quality algorithm vendor must be a 16-bit unsigned number.");
		ValidateTemplate.int16(algorithm, "Zonal quality algorithm must be a 16-bit unsigned number.");
