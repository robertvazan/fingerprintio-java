...
public class Ansi378v2009Am1CountExtension {
	...
	Ansi378v2009Am1CountExtension(byte[] extension, boolean lax) {
		TemplateUtils.decodeExtension(extension, in -> {
			type = TemplateUtils.decodeType(in.readUnsignedByte(), Ansi378v2009Am1CountType.class, lax, "Unrecognized edge picking method.");
