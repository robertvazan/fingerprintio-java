...
/**
 * Extension data block (<a href="https://templates.machinezoo.com/ansi378-2009#extension">EXTENSION</a>).
...
public class Ansi378v2009Extension {
	/**
	 * Extension type (<a href="https://templates.machinezoo.com/ansi378-2009#exttype">EXTTYPE</a>).
	 */
	public int type;
	/**
	 * Extension data (<a href="https://templates.machinezoo.com/ansi378-2009#extdata">EXTDATA</a>).
	 */
	public byte[] data;
	/**
	 * Creates new extension data block (<a href="https://templates.machinezoo.com/ansi378-2009#extension">EXTENSION</a>).
	 */
	public Ansi378v2009Extension() {
	}
	Ansi378v2009Extension(TemplateReader in) {
